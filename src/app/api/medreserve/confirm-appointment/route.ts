    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          ...
          <p>We're writing to confirm your upcoming medical appointment with ${doctorName ? `<strong>Dr. ${doctorName}</strong> at ` : ""}<strong>${process.env.NEXT_PUBLIC_COMPANY_NAME}</strong>.</p>
