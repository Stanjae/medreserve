            ...
            <Grid overflow="hidden">
              ...
              <GridCol span={{ base: 12, md: 6 }}>
                <CustomInput
                  ...
                  label="Allergies"
                  size="md"
                  placeholder="Enter any allegies you may have eg.Peanuts, Penicillin, Pollen"
              ...
              <GridCol span={{ base: 12, md: 6 }}>
                <CustomInput
                  ...
                  placeholder="Your medication Eg. Ibuprofen 200mg, Levothyroxine 50mcg"
              ...
              <GridCol span={{ base: 12, md: 6 }}>
                <CustomInput
                  type="textarea"
                  size="md"
                  label="Personal Past Medical History"
                  placeholder="Your Past medical history Eg. Appendectomy in 2015, Asthma diagnosis in childhood"
