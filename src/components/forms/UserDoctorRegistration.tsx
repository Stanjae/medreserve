...
import { IconCircleXFilled, IconRosetteDiscountCheckFilled } from '@tabler/icons-react';
...
const UserDoctorRegistrationForm = () => {
  ...
  const form = useForm({mode: 'uncontrolled',
    initialValues: {medId: '', email: '',password: '', username: '', terms_and_conditions: false},
  ...
  return (
    <Box className=' space-y-3' onSubmit={form.onSubmit(async(values) => await registerClient({...values, medId: medInfo?.doctorId}, 'doctor'))} 
    component='form'>

    <div>
        <CustomInput  radius={35} label='Medical ID' size='md' type='text' 
        placeholder='Enter your medical ID' key={form.key('medId')}
        ...
        <div className=' flex items-center gap-x-3'>
            ...
            <Text component='div' c="m-gray" className="flex text-[14px] items-center gap-x-1">
