        ...
        <div className=" mx-auto pb-5">
          <div className="bg-white  border border-gray-200 overflow-hidden mb-6">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                <Image
                  src={
                    record?.appointmentId?.doctorId?.profilePicture as string
                  }
                  alt="profile"
                  width={60}
                  height={60}
              ...
              <Group justify="flex-end">
                <Button
                  disabled={record?.isPrescriptionCompleted}
          ...
          <div className="mb-6 px-5">
            <Alert
              ...
              color="blue"
              title="About Your Medical Records"
            >
              Your medical records are securely stored and accessible only to
              you and your authorized healthcare providers
            </Alert>
          </div>
        </div>
      </Modal.Content>
