...
import useGetDashboardBarchartAnalytics from "@/hooks/doctor/useGetDashboardBarchartAnalytics";

type Props = {
  doctorDbId: string;
};
const DoctorDashboardBarChart = ({ doctorDbId }: Props) => {
    ...
    <Paper p={20} shadow="md" radius={"md"}>
      ...
      <BarChart
        ...
        series={[
          ...
          { name: "routineCheckup", color: "red.6" },
        ]}
        tickLine="y"
      />
    </Paper>
...
export default DoctorDashboardBarChart;
