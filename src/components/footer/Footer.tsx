...
import { footerLinks } from '@/constants/Toplinks'
            ...
            <div className=' flex justify-between'>
                ...
                <Group visibleFrom='xl' gap="50">
                    <a className=' flex gap-1 items-center' href="https://x.com">
                        <ThemeIcon color="m-gray" variant="transparent"><IconBrandX size={'20'}/></ThemeIcon>
                        <Text fz={20} lh={'25px'} c="m-background">Twitter</Text>
                    </a>
                    <a className=' flex gap-1 items-center' href="https://facebook.com">
                        <ThemeIcon color="m-gray" variant="transparent"><IconBrandFacebookFilled size={'20'}/></ThemeIcon>
                        <Text fz={20} lh={'25px'} c="m-background">Facebook</Text>
                    </a>
                    <a className=' flex gap-1 items-center' href="https://facebook.com">
                        <ThemeIcon color="m-gray" variant="transparent"><IconBrandYoutubeFilled size={'20'}/></ThemeIcon>
                        <Text fz={20} lh={'25px'} c="m-background">Youtube</Text>
                    </a>
                </Group>
            </div>
                    ...
                    <GridCol key={index} className=' space-y-2.5' span={{base:12, md:3}}>
                        ...
                        <Box py={41} className=' medFooterLinks space-y-4'>
                            ...
                            item.navLinks?.map((opera, i)=>(
                                <NavLink key={i} className=' duration-500 customFooterlink hover:bg-transparent hover:underline-offset-4 hover:underline text-background'
                                    href={opera.href}
                                    label={opera.label}
                                />
                            ))}
